...
java -cp "*" -mx1g edu.stanford.nlp.parser.lexparser.LexicalizedParser -PCFG -headFinder edu.stanford.nlp.trees.LeftHeadFinder -sentences newline -train "train_1" -saveToSerializedFile "SerializedModel1" -writeOutputFiles "AllPlainTextTweets"
